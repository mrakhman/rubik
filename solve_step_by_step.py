...
def print_this_step_moves(prev_step_moves_len, solver):
...
if __name__ == "__main__":
    ...
    if shuffle_spins:
        ...
        solver.step_1()
        step_1_moves_len = print_this_step_moves(0, solver)


        print("Step 2 - solve white side:\n")
        solver.step_2()
        step_2_moves_len = print_this_step_moves(step_1_moves_len, solver)


        print("Step 3 - second layer:\n")
        solver.step_3()
        step_3_moves_len = print_this_step_moves(step_2_moves_len, solver)


        print("Step 4 - yellow cross:\n")
        solver.step_4()
        step_4_moves_len = print_this_step_moves(step_3_moves_len, solver)


        print("Step 5 - yellow side:\n")
        solver.step_5()
        step_5_moves_len = print_this_step_moves(step_4_moves_len, solver)


        print("Step 6 - final step - Edges on third layer centers:\n")
        solver.step_6()
        step_6_moves_len = print_this_step_moves(step_5_moves_len, solver)
